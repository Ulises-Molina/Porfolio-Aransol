...
export const App: React.FC = () => {
    ...
    return (
        ...
        <main className="bg-black h-screen overflow-x-hidden">
            <section className="bg-red h-[80vh] w-screen flex flex-col justify-center items-center animate-fadeIn delay-500">
        ...
        <article id="first" className="h-screen bg-black flex justify-center gap-32">
        <motion.div
            initial= {{opacity: 0,scale: 0.85,rotate:-30}}
            whileInView={{opacity: 1, scale: 1,transition: {duration: 1.5},rotate:0}}>
                <img src="/third.webp" alt="tercera imagen" className="w-full h-full object-contain py-10"></img>
        </motion.div>
        <motion.div
            initial= {{opacity: 0,scale: 0.85,rotate:30}}
            whileInView={{opacity: 1, scale: 1,transition: {duration: 1.5},rotate:0}}>
                <img src="/four.webp" alt="cuarta imagen" className="w-full h-full object-contain py-10"></img>
            </motion.div>
        ...
        <footer className="bg-neutral-950 h-20 flex justify-center items-center">
